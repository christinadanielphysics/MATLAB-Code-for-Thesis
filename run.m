...
ylabel('$\Sigma^R_{\uparrow}(k=\frac{\pi}{a},\omega)$',Interpreter='latex')
...
xlabel('$\omega$',interpreter='latex') 
ylabel('$G^R_{\uparrow}(k=\frac{\pi}{a},\omega)$',Interpreter='latex')
...
xlabel('$\omega$',interpreter='latex') 
ylabel('$G0^R_{\uparrow}(k=\frac{\pi}{a},\omega)$',Interpreter='latex')
