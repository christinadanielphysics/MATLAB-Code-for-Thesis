classdef LesserGreen
    ...
    methods
        function obj = LesserGreen(spin,spatial_orbital_index_i,spatial_orbital_index_j,hubbard)
            ...
            a_max = length(obj.eigenvalues_for_hubbard_minus);
            weights = zeros(1,a_max); % array to store each product of two matrix elements; one product for each index a
            for a = 1:a_max
                matrix_element_1 = MatrixElement("creation",spatial_orbital_index_j,spin,1,hubbard,a,hubbard_minus,obj.system,obj.system_minus_up,obj.system_minus_down,obj.system,obj.system,"lesser");
                matrix_element_2 = MatrixElement("annihilation",spatial_orbital_index_i,spin,a,hubbard_minus,1,hubbard,obj.system,obj.system_minus_up,obj.system_minus_down,obj.system,obj.system,"lesser");
